...
import { getOpeningHours, isStaffForResource } from '../../../../../utils/resourceUtils';
...
const openingHoursSelector = createSelector(
  resourceSelector,
  dateSelector,
  (resource, date) => getOpeningHours(resource, date)
);

export const availabilityTimelineSelector = createStructuredSelector({
  items: itemsWithSelectionDataSelector,
  slotSize: slotSizeSelector,
  openingHours: openingHoursSelector,
});
...
const AvailabilityTimelineContainer = connect(
  availabilityTimelineSelector, actions)(AvailabilityTimeline);
